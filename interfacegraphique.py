...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_numero.setGeometry(QtCore.QRect(170, 30, 271, 31))
        font = QtGui.QFont()
        ...
        self.textBrowser_afficher.setGeometry(QtCore.QRect(160, 520, 951, 171))
        ...
        self.pushButton_supprimer.setGeometry(QtCore.QRect(670, 340, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_modifier.setGeometry(QtCore.QRect(420, 340, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_programme.setGeometry(QtCore.QRect(530, 190, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.comboBox_programme.setGeometry(QtCore.QRect(530, 230, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButton_afficher_listview.setGeometry(QtCore.QRect(670, 420, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.dateEdit_DNaiss.setGeometry(QtCore.QRect(520, 70, 301, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_date_naiss.setGeometry(QtCore.QRect(520, 30, 271, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.pushButton_serealiser.setGeometry(QtCore.QRect(420, 420, 151, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_erreur_date.setGeometry(QtCore.QRect(520, 120, 371, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_erreur_fichier.setGeometry(QtCore.QRect(330, 480, 541, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_Numero_Casier.setGeometry(QtCore.QRect(860, 30, 271, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.lineEdit_numero_casier.setGeometry(QtCore.QRect(860, 70, 231, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setItalic(True)
        self.lineEdit_numero_casier.setFont(font)
        self.lineEdit_numero_casier.setObjectName("lineEdit_numero_casier")
        self.comboBox_localisationCasier = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_localisationCasier.setGeometry(QtCore.QRect(870, 410, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.comboBox_localisationCasier.setFont(font)
        self.comboBox_localisationCasier.setObjectName("comboBox_localisationCasier")
        self.comboBox_localisationCasier.addItem("")
        self.comboBox_localisationCasier.addItem("")
        self.comboBox_localisationCasier.addItem("")
        self.label_localisation_Casier = QtWidgets.QLabel(self.centralwidget)
        self.label_localisation_Casier.setGeometry(QtCore.QRect(870, 360, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        font.setItalic(True)
        font.setWeight(75)
        self.label_localisation_Casier.setFont(font)
        self.label_localisation_Casier.setObjectName("label_localisation_Casier")
        self.comboBox_tailleCasier = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_tailleCasier.setGeometry(QtCore.QRect(860, 230, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.comboBox_tailleCasier.setFont(font)
        self.comboBox_tailleCasier.setObjectName("comboBox_tailleCasier")
        self.comboBox_tailleCasier.addItem("")
        self.comboBox_tailleCasier.addItem("")
        self.comboBox_tailleCasier.addItem("")
        self.label_Taille_Casier = QtWidgets.QLabel(self.centralwidget)
        self.label_Taille_Casier.setGeometry(QtCore.QRect(860, 190, 271, 41))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_erreur_casier = QtWidgets.QLabel(self.centralwidget)
        self.label_erreur_casier.setEnabled(True)
        self.label_erreur_casier.setGeometry(QtCore.QRect(860, 120, 371, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_erreur_casier.setFont(font)
        self.label_erreur_casier.setObjectName("label_erreur_casier")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_erreur_date.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\">Date de naissance invalide.</span></p><p><span style=\" color:#ff0000;\"> L\'âge doit être supérieur à 18 ans.</span></p></body></html>"))
        ...
        self.label_Numero_Casier.setText(_translate("MainWindow", "Numéro de casier"))
        self.comboBox_localisationCasier.setItemText(0, _translate("MainWindow", "Bloc A"))
        self.comboBox_localisationCasier.setItemText(1, _translate("MainWindow", "Bloc B"))
        self.comboBox_localisationCasier.setItemText(2, _translate("MainWindow", "Bloc C"))
        self.label_localisation_Casier.setText(_translate("MainWindow", "Localisation du casier"))
        self.comboBox_tailleCasier.setItemText(0, _translate("MainWindow", "Petit"))
        self.comboBox_tailleCasier.setItemText(1, _translate("MainWindow", "Moyen"))
        self.comboBox_tailleCasier.setItemText(2, _translate("MainWindow", "Grand"))
        self.label_Taille_Casier.setText(_translate("MainWindow", "Taille du caiser"))
        self.label_erreur_casier.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ff0000;\">Numéro de casier invalide.                    </span></p><p><span style=\" color:#ff0000;\">Le numéro de casier doit être une lettre et de 4 chiffres.</span></p></body></html>"))
